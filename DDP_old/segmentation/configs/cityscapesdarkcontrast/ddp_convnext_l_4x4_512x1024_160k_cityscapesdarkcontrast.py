_base_ = [
    '../_base_/datasets/cityscapesdarkcontrast.py',
...
evaluation = dict(interval=500, metric='mIoU', save_best='mIoU', pre_eval=True) # changed to 500 for self aligned denoising
