...
class DistEvalHookMultiSteps(DistEvalHook):
    def evaluate(self, runner, results):
        ...
        """
        collect_timesteps = list(range(0, runner.model.module.schedule_steps)) 
        eval_res = self.dataloader.dataset.evaluate_diffusion(
            results, collect_timesteps=collect_timesteps, 
    ...
    def _save_ckpt(self, runner, key_score): 
        ...
        """
        key_score = key_score[-1] # last timestep of the reverse diffusion to save 
        if self.by_epoch:
