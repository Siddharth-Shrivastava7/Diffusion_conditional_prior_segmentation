...
log_level = 'INFO'
load_from = 'https://huggingface.co/yfji/DDP-Weight/resolve/main/ddp_convnext_l_4x4_512x1024_160k_cityscapes.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/ddp_convnext_l_4x4_512x1024_5k_cityscapes_aligned'
gpu_ids = range(0, 4)
auto_resume = False
