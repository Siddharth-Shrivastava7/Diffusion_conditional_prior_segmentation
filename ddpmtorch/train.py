...
def main():
    ...
    parser.add_argument("--dataset", choices=["mnist", "cifar10", "celeba", "celebahq", "cityscapes"], default="cityscapes")
    parser.add_argument("--root", default="~/scratch/dataset", type=str, help="root directory of datasets")
    ...
    parser.add_argument("--image-intv", default=2, type=int)
    parser.add_argument("--num-save-images", default=8, type=int, help="number of images to generate & save")
