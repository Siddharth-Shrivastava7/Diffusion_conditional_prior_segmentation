...
class EncoderDecoder(BaseSegmentor):
    ...
    def slide_inference(self, img, img_meta, rescale):
        ...
        rescale = False ## hard coding 
        if rescale: # can make it false or change ori_shape for resizing  
            preds = resize(
                preds,
    ...
    def inference(self, img, img_meta, rescale):
        ...
        if hasattr(self.decode_head, 'debug_output_attention') and \
            ...
            # output = F.softmax(seg_logit, dim=1) # not taking softmax for now
            output = seg_logit
    ...
    def simple_test(self, img, img_meta, logits_output=False, rescale=True):
    ...
    def aug_test(self, imgs, img_metas, logits_output= False, rescale=True):
