...
def get_arguments():
    ...
    parser.add_argument(
        '--test-set',
        action='store_true', # changing from store_true since, to use in .ipynb file
...
def main():
    args = get_arguments() # changing to empty string to be used in ipynb file 
    ...
    #     # print('>>>>>>>>>>>>',outputs) # empty list aa rhi h
    ...
    #focusing on getting the model and dataloader 
    if not distributed:
