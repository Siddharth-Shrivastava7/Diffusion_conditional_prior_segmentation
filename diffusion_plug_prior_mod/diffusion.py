...
class GaussianDiffusion():
    ...
    def inverse(self, net, shape=(1,64,64), steps=None, x=None, start_t=None, device='cpu'):
        ...
        for t in range(start_t, start_t-steps, -1):
            at = self.alpha[t-1] # for the concern of python indexing starting from t-1 so that at the end will end up in (start_t-steps)th step. 
            ...
            else: # at t=1 it makes sense not to include noise in this step as this will be the final step and we will be needing point estimate
