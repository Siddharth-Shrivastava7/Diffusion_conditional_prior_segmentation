...
map_id_to_train_id[map_id_to_train_id==255] = 19
...
def train_label_img_to_color(img): 
    ...
    img_color = img_color.unsqueeze(dim=0).permute(0, 3, 1, 2)
    return img_color
...
def cityscapes_train_indices_segmentation_to_img(img):
    # return train_label_img_to_color(img)
    return indices_segmentation_to_img(img, colors= train_COLORS)
