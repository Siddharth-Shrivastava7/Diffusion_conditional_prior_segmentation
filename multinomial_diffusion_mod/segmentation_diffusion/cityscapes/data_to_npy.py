...
def main(H, W):
    ...
    data_set = Cityscapes(
            root='/home/sidd_s/scratch/dataset/cityscapes/', split='train', mode='fine', target_type='semantic',
            transform=data_transforms, target_transform=None, transforms=None,
            only_categories=False)
    test_set = Cityscapes(
        root='/home/sidd_s/scratch/dataset/cityscapes/', split='val', mode='fine', target_type='semantic',
        transform=data_transforms, target_transform=None, transforms=None,
        only_categories=False)
    ...
    root = '/home/sidd_s/scratch/dataset/cityscapes/preprocessed'
