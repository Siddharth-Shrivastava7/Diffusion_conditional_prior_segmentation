...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', default='/home/guest/scratch/siddharth/data/dataset/DarkZurich/rgb_anon/val/night/GOPR0356/GOPR0356_frame_000321_rgb_anon.png', type=str, help='path of the extracted image.')
    parser.add_argument('--output_path', default='/home/guest/scratch/siddharth/models/Diffusion_conditional_prior_segmentation/ccdm-stochastic-segmentation_mod/test.pt', type=str, help='path to file containing extracted descriptors.')
