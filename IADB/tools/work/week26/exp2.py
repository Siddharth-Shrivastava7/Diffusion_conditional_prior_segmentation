...
model = dict(
    ...
    auxiliary_head=dict(
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0.5, avg_non_ignore=True)),
    train_cfg=dict(),   
...
work_dir = '/home/sidd_s/scratch/mmseg_work_dir/week26/exp2/'  
...
optimizer = dict(type='Adam', lr=1e-3, weight_decay=0.0005)
